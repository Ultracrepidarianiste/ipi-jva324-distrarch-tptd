...
public class ProduitEnStock {
    ...
    public long getQuantiteDisponible() { return quantiteDisponible; }
    public void setQuantiteDisponible(long quantiteDisponible) { this.quantiteDisponible = quantiteDisponible; }
