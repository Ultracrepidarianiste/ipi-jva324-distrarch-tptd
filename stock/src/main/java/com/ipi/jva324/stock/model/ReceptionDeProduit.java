...
public class ReceptionDeProduit {
    ...
    public String getIdProduitExterne() { return idProduitExterne; }
    public void setIdProduitExterne(String idProduitExterne) { this.idProduitExterne = idProduitExterne; }
    public long getQuantiteRecue() { return quantiteRecue; }
    public void setQuantiteRecue(long quantiteRecue) { this.quantiteRecue = quantiteRecue; }
